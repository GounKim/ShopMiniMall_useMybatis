				...
				<table align="center" width="710" cellspacing="0" cellpadding="0" border="0" style='margin-left: 30px'>
					...
					<tr>
						...
						<td colspan="2" style='padding-left: 30px'>
							<select class="select_change" size="1" name="goods_size" id="GOODS_SIZE">
					...
					<tr>
						...
						<td style="padding-left: 30px">
							<input type="text" name="goods_amount" value="1" 
									id="goods_amount" style="text-align: right; height: 18px"> 
