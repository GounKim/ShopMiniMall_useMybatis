...
<c:forEach var="dto" items="${cartList}" varStatus="status">		
		...
		<tr>
			<td class="td_default" width="80">
				...
				<input type="checkbox" name="check" id="check${dto.num}" class="check" value="${dto.num}">
			</td>
			<td class="td_default" width="80">
				${dto.num}
			</td>
			...
			<td class="td_default" align="center" width="90">
				<input class="input_default" type="text" name="cart_amount" 
					id="cart_amount${dto.num}" value="${dto.gAmount}" data-amount="xxx"
			...
			<td>
				<input type="button" value="주문" onclick="order(${dto.num})">
			</td>
