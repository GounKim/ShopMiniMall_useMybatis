...
<c:set var="totalSum"  value="${totalSum + cart.gPrice * cart.gAmount}" />
					...
					<tr>
						...
						<td class="td_default" width="80">
							<img src="images/items/${cart.gImage}.gif" border="0" align="center" width="80" />
						</td>
					...
					<tr>
						...
						<td height="35" class="td_default">
							...
							<input class="input_default" type="text" id="maddress2" size="35"
								maxlength="200" value="${mDTO.addr2}" readonly />
						</td>
					</tr>
					...
					<tr>
						...
						<td height="35" class="td_default">
							<input class="input_default" type="text" id="mphone" size="15"
									value="${mDTO.phone1}-${mDTO.phone2}-${mDTO.phone3}" maxlength="15" />
						</td>
					</tr>
				</table>							
			</td>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default">
							...
							<br>
							<input name="addr1" id="addr1" size="40" placeholder="도로명주소" readonly="readonly">
							<br>
